...
{
private:
// shape share static variable shapeCount
static int shapeCount; 
// Initialize shapeCount to 0 in Shape.cpp. protected:
int width, height; // Both width and height must always be >= 2.
const int ID;
 // Set ID to ++shapeCount in the the constructor init list.
public:
Shape(int w = 2, int h = 2); 
